    ...
    public void execute(Player banner, String[] args) {
        ...
        PalaceBungee.getProxyServer().getScheduler().runAsync(PalaceBungee.getInstance(), () -> {
            try {
                ...
                PalaceBungee.getMessageHandler().sendMessage(new KickPlayerPacket(uuid, ChatColor.RED + "You Have Been Banned For " + ChatColor.AQUA + reason), PalaceBungee.getMessageHandler().ALL_PROXIES);
